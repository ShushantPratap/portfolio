...
import {SquareArrowOutUpRight, Github, Sparkles } from "lucide-react";
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 p-2 dark:text-gray-50">
                    ...
                    <div className="mt-5 sm:px-5 sm:mt-5">
                        <a
                            ...
                            rel="noopener noreferrer"
                            className="flex items-center border-2 border-theme hover:bg-[#9b59b6] text-white p-3 mb-2 rounded-full text-sm font-medium transition duration-300 ease-in-out"
                        >
                            <SquareArrowOutUpRight size={18} className="mr-2" />Live Demo
                        </a>
                        <a
