...
import { Mail, Lightbulb, Bot } from "lucide-react";
import { CovertLatterGen, ProjectIdeaGen, Card, ChatBot } from "../components/index";
...
function AI_assistant() {
    ...
    const aiCard = [
        ...
        },
        {
            ...
            icon: <Lightbulb size={28} className="mr-3 text-theme" />,
        ...
        },
        {
            ...
            name: "ChatBot",
            linkName: "ChatBot",
            path: '/ai-assistant/chatbot',
            icon: <Bot size={28} className="mr-3 text-theme" />,
            component: <ChatBot name="Shushant pratap" />,
            description: "Get creative project ideas based on your interests or desired technologies.",
